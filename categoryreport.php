...
<?php
$count=1;
$sel_query="Select * from category ORDER BY categoryid ASC";
...
<td align="center"><?php echo $row["descripton"]; ?></td>
<td align="center">
	<a href="delete6.php?id=<?php echo $row["categoryid"];?>">Delete</a>
</td>
</tr>
<?php $count++; }} ?>
</tbody>
